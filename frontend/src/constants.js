...
const FEEDBACK_PASS = 'Please enter a password (min 6 symbols - lowercase/uppercase only latin letters and numbers)';
const FEEDBACK_LINK = 'Please enter a link type http://....';
const FEEDBACK_TEXT = 'Please enter a page name (minimum 3 symbols, only digits or letters)';
